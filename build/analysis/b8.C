...
//  TFile f("B4_photon_20keV.root");
  ...
  double rg=20.0;
  double rg2=0.002;
  TH2F *pi00 = new TH2F("pi00","pixel0",400,0.0,16.0,400,0.0,16.0);
  TH2F *pi01 = new TH2F("pi01","pixel1",400,0.0,40.0,400,0.0,40.0);
  //  TH2F *pi01 = new TH2F("pi01","pixel1",400,0.0,40.0,400,0.0,40.0);
  //  TH2F *pi02 = new TH2F("pi02","pixel2",400,-rg2,rg2,400,-rg2, rg2);
  //  TH2F *pi03 = new TH2F("pi03","pixel3",400,-rg2,rg2,400,-rg2, rg2);
  TH1F *h001 = new TH1F("h001", "mRadian", 50, -10.0,10.0);
  TH1F *h002 = new TH1F("h002", "dx", 50, -10.0,10.0);
...
#define NL (6)
  ...
  for(int ievent=0; ievent<Nev;ievent++) {
	...
	x[il] =w[il]*(x[il]/e[il]+0.5-ofs[il]);
	...
	if (x00< 0 ) x00 = x00+zz;
      ...
      pi00 -> Fill(((ievent-8)%64)*0.25,x00);
      h002 -> Fill(ievent*0.25-x[0]-510.0);
	...
	if (x00< 0 ) x00 = x00+zz;
      ...
      pi01 -> Fill(((ievent)%160)*0.25,x00);
      h001->  Fill(ievent*0.25-x[2]-510.0);
      //    pi01 -> Fill (ievent*0.25,x[2]+500);
